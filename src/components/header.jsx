...
function Header(){
    ...
    return(
        ...
        <div className="flex justify-around container max-w-[80%] mx-auto">
          ...
          <Link to="./restaurant"><img className=" object-cover h-80 w-80"src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/b5c57bbf-df54-4dad-95d1-62e3a7a8424d_IM3BU.png" alt="" /></Link>
            <Link to="./restaurant"><img className="object-cover h-80 w-80"src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/b6d9b7ab-91c7-4f72-9bf2-fcd4ceec3537_DO3BU.png" alt="" /></Link>
        </div>
