    ...
    return(
        ...
        <div className="pt-4 pb-9 relative">
            ...
            <div className="max-w-[60%] text-5xl text-white font-bold container mx-auto flex text-center ">
                Order food for your guchu puchu anshika today!!!</div>
        ...
        <div className="flex justify-around container max-w-[80%] mx-auto">
            <a href="https://www.swiggy.com/restaurants"><img className="h-80 w-80"src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/ec86a309-9b06-48e2-9adc-35753f06bc0a_Food3BU.png" alt="" /></a>
            <a href="https://www.swiggy.com/instamart?entryId=1234&entryName=mainTileEntry4&v=1"><img className="h-80 w-80"src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/b5c57bbf-df54-4dad-95d1-62e3a7a8424d_IM3BU.png" alt="" /></a>
            <a href="https://www.swiggy.com/dineout"><img className="h-80 w-80"src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/b6d9b7ab-91c7-4f72-9bf2-fcd4ceec3537_DO3BU.png" alt="" /></a>
        </div>
