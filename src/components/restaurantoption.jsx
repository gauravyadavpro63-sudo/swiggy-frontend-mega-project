...
return(
   ...
   <Link to="./restaurant"><div className="flex relative  rounded-t-2xl">
  <img className="md:h-48 md:min-w-80 h-20 min-w-40 rounded-t-2xl "src={`https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/${data.info.mediaFiles[0].url}`} alt="img" />
