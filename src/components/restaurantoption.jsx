...
return(
    ...
    <div className="flex relative border rounded-2xl">
  <img className="h-48 min-w-80 border rounded-2xl "src={`https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/${data.info.mediaFiles[0].url}`} alt="img" />
